...
barriers are noted as they arrive over the wire. Illegal actions leave the state
unchanged so a caller can safely fall back (e.g. to HOLD).
"""
...
class OwnGameState:
    ...
    def __init__(
        ...
        self.barriers: set[Cell] = set()  # all known barriers (mine + opponent-declared)
        self.my_barriers = 0
        self.step_number = 0
        self.log: list[dict] = []
