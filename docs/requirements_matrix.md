...
| FR-17 | Sealed logs; mutual audit; replay integrity + reconstruction | Book ch.7; Ref `gui/replay*` | 6/7 | WIP (sealed logs + mutual audit done 6.1-6.3; replay data layer — commit-reveal re-verify + both-trajectory reconstruction from revealed logs 7.5a; Tk playback 7.5b) | `test_replay_data`, `test_replay_normalize`, `test_audit` |
