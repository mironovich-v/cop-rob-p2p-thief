...
| 2026-08-17 | PR (7.9) | chore-ci-gate | (pending) | Fable 5 · high | CI gate workflow (ruff, cov, conformance, kit oracle, drift check) + PROGRESS/matrix refresh (AC1 done) | ~0.05 session | in review |
