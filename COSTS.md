...
| 2026-08-18 | PR (8.14) | config-nis-yar1-pairing | (pending) | Fable 5 · high | role-split opponent dialing + nis-yar1 pairing config (digest verified, ids pinned) + reply draft + league template | ~0.15 session | in review |
