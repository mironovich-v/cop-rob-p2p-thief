...
| 2026-07-29 | PR (7.3b) | stage-7-gmail-send | (pending) | Opus 4.8 · high | raw-HTTPS Gmail send-only client + gatekeeper-routed EmailSender (draft/disabled default, no new deps) | ~0.2 session | in review |
